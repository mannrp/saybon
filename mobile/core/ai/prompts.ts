// Saybon v2 — AI Prompt Templates for Exercise Generation
import type { GenerationParams } from './provider.interface';
...
- Difficulty 1-5 scale`;
  ...
  // Guidance instructions for other exercise types
  const typeInstructions = {
    ...
    'tense-correction': 'Give a French sentence with a verb in the wrong tense, and ask for the correct conjugated verb. Example: "Correct the verb tense: Demain, je mangais (manger) une pomme."',
    'sentence-reorder': 'Provide a jumbled set of French words and ask to reorder them into a correct sentence. Example: "Reorder these words: [\'suis\', \'je\', \'fatigué\']"',
    'identify-error': 'Provide a French sentence with a single grammatical error, and ask to write the corrected sentence. Example: "Identify and fix the error: Elle est parti."',
    'gender-recognition': 'Ask whether a French noun is masculine or feminine. Example: "What is the gender of the noun \'table\'?"',
    'sentence-rebuilding': 'Provide a basic French sentence and ask to rebuild it with specific extensions (e.g. add an adjective or negative). Example: "Make this sentence negative: Je parle français."',
    'morphology': 'Ask to decompose a complex word or identify its prefix/suffix. Example: "What is the suffix of \'impossiblement\'?"',
